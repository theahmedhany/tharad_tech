...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$LogoutStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
abstract class Idle<T> implements LogoutState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$LogoutStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
abstract class Loading<T> implements LogoutState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$LogoutStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
abstract class Success<T> implements LogoutState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$LogoutStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'LogoutState<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements LogoutState<T> {
