...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$OtpStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
abstract class Idle<T> implements OtpState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$OtpStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
abstract class Loading<T> implements OtpState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$OtpStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'OtpState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements OtpState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$OtpStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'OtpState<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements OtpState<T> {
